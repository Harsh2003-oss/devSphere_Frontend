...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 flex items-center justify-center px-4">
      ...
      <img className="w-16 h-16 rounded-4xl object-cover" src="dev_logo.jpeg" alt="Logo" />
        ...
        <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl p-8 border border-white/20">
          ...
          {error && (
            <div className="mb-4 p-3 bg-red-500/20 border border-red-500/50 rounded-lg text-red-200 text-sm flex items-start">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-center">
              <input
                ...
                name="remember-me"
                type="checkbox"
                className="h-4 w-4 bg-white/5 border-white/10 rounded text-purple-500 focus:ring-purple-500 focus:ring-offset-gray-900"
              />
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              <button
                type="button"
                className="w-full inline-flex justify-center items-center py-2.5 px-4 border border-white/10 rounded-lg bg-white/5 hover:bg-white/10 transition text-sm font-medium text-white"
              >
